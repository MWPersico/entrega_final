...
<body>
    ...
    <div class="links">
        <h3> Produções: </h3>
        <ul>
            <li><a href="validacao.php"><button class="link_btn">Funções de validação</button></a></li>
            <li><a href="parimp.php"><button class="link_btn">Validando nome e idade</button></a> <= Exercício</li>
        </ul>
    </div>
